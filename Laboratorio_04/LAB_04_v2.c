#include<xc.h>
#define _XTAL_FREQ 1000000      // Frecuencia 1 MHz - Va antes de la inclusión de la librería
...
unsigned char *FIN[] = "  ¡COMPLETADO! ";       // Ultimo Mensaje LCD
...
void main(void){
    ...
    TRISA = 0x00;       // A5:Enable pantalla=0 //A4:LuzdeFondo //A3:RS=0 
    ...
    TRISC = 0xFF;       // Poner todo el puerto C como entrada
    TRISE = 0x00;       // RGB
    ...
    if(RI == 1){ 
        ...
        contador = 0;
        BorraLCD();
        MensajeLCD_Var("Bienvenidos");   // Muestra el mensaje de bienvenida
   ...
   // Detecta si se reseteo por software, si el numero ingresado no es válido
    ...
    while(1){
        ...
        while(1){
            ...
            unsigned char Actual_RA0 = RC1; // Lee el estado actual del pin RA0
